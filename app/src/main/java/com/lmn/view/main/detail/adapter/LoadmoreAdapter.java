...
public class LoadmoreAdapter extends BaseQuickAdapter<String,BaseViewHolder> {
    ...
    ImageFactory.getLoader().loadNet(mContext.getApplicationContext(),(ImageView) helper.getView(R.id.img),item,new ILoader.Options(R.drawable.loading_img,R.drawable.error_img));
    }
}
